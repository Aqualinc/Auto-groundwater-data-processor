...
#After updating, need to go through and delete all the shorter files of the duplicated APP sites, these are the ones that have been updated.

```{r}
if (!require(zoo)) install.packages("zoo"); library(zoo)
if (!require(lubridate)) install.packages("lubridate"); library(lubridate)

PreviousDataDirectory <- "H:\\WL Projects\\WL20023_CCC APP\\AllData"
LatestDataDirectory <- "D:\\Projects\\Aqualinc\\projects\\APP\\Data\\Data Harvest 202009B\\BaroAndOffsetCorrected"
#LatestDataDirectory <- "H:\\WL Projects\\WL20023_CCC APP\\Data 2020\\BaroAndOffsetCorrected"


SaveDataDirectory <- "H:\\WL Projects\\WL20023_CCC APP\\AllData"

#Prepare a list of all the APP numbers

#Get a file list from the download data directories
DownloadFileNames <- list.files(path=c(PreviousDataDirectory,LatestDataDirectory),pattern="^APP[0-9]{4}_[0-9]{8}-[0-9]{8}\\.csv",full.names = TRUE)
...
for (APPNumber in APPNumbersToUpdate[67]) { #APPNumber <- 5
  ...
  #There are two types of files, Aqualinc formatted (which has a filename that starts with "APP") and T&T formatted. Aqualinc has a single header line. T&T has 12 header lines.
  ...
  #It seems the locale is different from machine to machine. I have locale on my laptop set to "English_New zealand.1252" which has the am/pm format as am/pm or AM/PM, but NOT a.m./p.m.. So completely different to what was working at Aqualinc! I haven't checked the Aqualinc locale yet.
